...
with open("./Texts/sign_challenge1.txt", "w", encoding="utf-8") as f:
    f.write("twerp reply visor ahead churl")
...
cmd = [
    ...
    "./Texts/sign_challenge1.txt"               # Fichier contenant le message à signer
]
...
with open("./Hexa/sign_challenge1.hex", "w", encoding="utf-8") as f:
    f.write(hex_content)
