...
p = int("")

q = int("")
...
with open("armoire.pem", "wb") as f:
    f.write(pem)

challenge = b"rinse gouty sulks colic kaiak"
sig = private_key.sign(challenge, padding.PKCS1v15(), hashes.SHA256())

print("PEM écrit dans armoire.pem")
print("Signature hex :")
print(sig.hex())