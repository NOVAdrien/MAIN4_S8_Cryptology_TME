...
def main():
    ...
    challenge_hex = "639c33e00dc8147b69a6ae73c0f29382cb2ca5d1140ac74d385f4f3dd252b31c827e2d565944e8ed89bd3a7670e63f039d2a80d7e7a81d4f8a1f0dbaa1c4fe5d695f32082018415370497c675e178148"
    ...
    for target_idx in range(2, 0, -1):
        ...
        for byte_idx in range(15, -1, -1):
            ...
            with open("./Texts/current_batch.txt", "w") as f:
                f.write("\n".join(payloads) + "\n")
                
            print(f"[!] COPIEZ le contenu du fichier './Texts/current_batch.txt' et collez-le dans le mode BATCH du jeu.")
